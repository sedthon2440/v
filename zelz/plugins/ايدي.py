...
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝙈𝙖𝙏𝙍𝙞𝙭 ─┄─┄─┄─⋆"
zed_dev = (9260465030, 9981066109, 9373798952)
zel_dev = (9260465030, 9981066109, 9373798952)
zelzal = (7291869416, 7291869416)
